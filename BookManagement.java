    ...
    public void searchBookByTitle() {
        ...
        while (true) {
            ...
            if (searchedBook != null) {
                AudioPlayer.playSound("src/CA1_DIT2B22_JovanYapKeatAn_LauChunYi/sounds/success.wav");
                JOptionPane.showMessageDialog(
                    null, 
                    String.format(
                        "<html>" +
    ...
    public void promptAndAddBook() {
        ...
        while (true) {
            ...
            if (!ISBN.matches("\\d{1,}")) { // Check if format of ISBN string is a valid integer
                ...
                if (ISBNduplicated) {
                    AudioPlayer.playSound("src/CA1_DIT2B22_JovanYapKeatAn_LauChunYi/sounds/fail.wav");
                    JOptionPane.showMessageDialog(
                        null, 
